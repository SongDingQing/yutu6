...
- `starlaid-unity-project`: Starlaid Unity/Tuanjie automation factory game, GitHub SSH/version control, lightweight Studio process, and the `starlaid-game-development` skill for future gameplay/system/QA/performance/art/release work. Trigger phrases include `Starlaid`, `星桥核心`, `自动化工厂`, `Starlaid repo`, `Starlaid game development`, `优秀游戏开发`, and `游戏开发技能`.
