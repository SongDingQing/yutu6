...
const allTests = [
  ...
  'no-claude-active-routing.test.js',
  ...
  'quality-proposal-triage.test.js',
  ...
  'react-taskboard-candidate-separation.test.js',
  ...
  'workspace-snapshot.test.js',
  'attachment-staging.test.js',
  'frontend-module-boundaries.test.js',
  'react-control-gateway.test.js',
  'task-detail-safety.test.js',
  'frontend-budget.test.js',
  'frontend-route-switch.test.js',
  'frontend-canary.test.js',
  'react-settings.test.js',
  'project-routing.test.js',
  'magicmushroom-department.test.js',
  'cli-runner.test.js',
  ...
  'yutu6-startup.test.js',
  'agent-platforms.test.js',
  'a2a-client.test.js',
  'model-fabric.test.js',
  'zhipu-coding-plan-contract.test.js',
